...
<node TEXT="物理层的过程" ID="ID_1719201410" CREATED="1542448382090" MODIFIED="1542448385656">
...
<html>
  ...
  <body>
    <p>
      预编码绝对是LTE中的核心中的核心，LTE系统中，默认使用多天线技术，多天线技术是LTE技术的一个核心技术，而预编码关系到的就是多天线系统的使用方式。
    </p>
    <p>
      同时预编码也是LTE中的一个比较难理解的点。
    </p>
    <p>
